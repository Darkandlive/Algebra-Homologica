...
\cs_new:Nn \nicolas_commutativesquare:n
{
	...
	\begin{tikzcd}[ampersand~replacement=\&,#1]
		\if \pushpull h
			...
			\l_nicolas_commutativesquare_B_tl \arrow{d}{\l_nicolas_commutativesquare_h_tl}\\
			\if \testfull t
			\&
			\fi\l_nicolas_commutativesquare_C_tl \arrow{r}[swap]{\l_nicolas_commutativesquare_k_tl} \& \l_nicolas_commutativesquare_D_tl
		\else \if \pushpull l
			\if \testfull t
			\l_nicolas_commutativesquare_P_tl
			\& \& \\
			...
			\fi
			\l_nicolas_commutativesquare_C_tl \arrow{u}{\l_nicolas_commutativesquare_g_tl}  \& \l_nicolas_commutativesquare_D_tl\arrow{l}{\l_nicolas_commutativesquare_k_tl}\arrow{u}[swap]{\l_nicolas_commutativesquare_h_tl}
			\fi
		\fi
