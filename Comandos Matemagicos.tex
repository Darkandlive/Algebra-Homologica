...
{
	\begin{tikzcd}[ampersand~replacement=\&,#1]
		 \&\l_nicolas_snakelem_A_tl\arrow{r}{\l_nicolas_snakelem_AtoB_tl}\arrow{d}[swap]{\l_nicolas_snakelem_AtoAp_tl}\& \l_nicolas_snakelem_B_tl\arrow{r}{\l_nicolas_snakelem_BtoC_tl}\arrow{d}{\l_nicolas_snakelem_BtoBp_tl}\& \l_nicolas_snakelem_C_tl\arrow{r}\arrow{d}{\l_nicolas_snakelem_CtoCp_tl} \& 0\\
		 0\arrow{r}\& \l_nicolas_snakelem_Ap_tl\arrow{r}[swap]{\l_nicolas_snakelem_AptoBp_tl}\&\l_nicolas_snakelem_Bp_tl\arrow{r}[swap]{\l_nicolas_snakelem_BptoCp_tl}\& \l_nicolas_snakelem_Cp_tl
	\end{tikzcd}
}
